...
def main():
    with tf.Session() as sess:
        ...
        tf.io.write_graph(frozen_gd, "../pb/", "frozen_shape.pb", as_text=False)
        tf.io.write_graph(frozen_gd, "../pb/", "frozen_shape.pbtxt", as_text=True)


def test():
    graph_def = tf.get_default_graph().as_graph_def()
    with gfile.FastGFile('../pb/frozen_shape.pb', 'rb') as f:
